...
struct mtk_panel_params {
	...
	unsigned int cust_esd_check_gpio;
	unsigned int esd_check_enable;
	unsigned int cust_esd_check_eint;
...
//Settings for LFR Function:
	...
	*/
	...
	bool first_eventloop_enable;
	unsigned int panel_bpp;
	unsigned int oplus_display_lcd_tp_aod;
	unsigned int cabc_three_to_zero;
	unsigned int oplus_display_global_dre;
	unsigned int oplus_display_color_mode_suppor;
	/*#endif*/
};
