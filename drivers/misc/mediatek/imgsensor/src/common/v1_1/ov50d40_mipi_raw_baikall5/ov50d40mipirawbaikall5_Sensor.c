...
#include "ov50d40mipirawbaikall5_Sensor.h"
#include "ov50d40_Sensorbaikall5_setting.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV50D40_SENSOR_ID_BAIKALL5,
    ...
    .custom2 = {
        .pclk = 100000000, /*3840x2160_60.0fps*/
        .linelength = 700,
        .framelength = 2380,
        .startx =0,
        .starty = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] = {
	...
	{ 8192,  6144, 256, 912, 7680,  4320,  3840,  2160,  0000,  0000,  3840,  2160,  0,  0,  3840,  2160},	/*custom2 video 60fps*/
	{ 8192,  6144,  0, 1024, 8192,  4096,  4096,  2048,  0000,  0000,  4096,  2048,  0,  0,  4096,  2048},	/*custom3 18:9*/
};
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_cap = {
    ...
    .i4BlockNumX = 248,
    .i4BlockNumY = 190,
    .i4Crop = { {0, 0}, {0, 0}, {8, 388}, {0, 0}, {0, 384},
        {0, 0}, {0, 0} ,{128, 456} },
};
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_video = {
    ...
    .i4BlockNumX = 248,
    .i4BlockNumY = 144,
    .i4Crop = { {0, 0}, {0, 0}, {0, 388}, {0, 0}, {0, 384},
        {0, 0}, {0, 0},{128, 456} },
};
...
static void write_shutter(kal_uint32 shutter)
{
    ...
    LOG_DBG("write_shutter _is_binning_size %d shutter %d lastshutter %d %d frame_length %d",
...
{
    kal_uint32 addr_ovpd = 0x1B08, senaddr_ovpd = 0x59f0;
    kal_uint16 i = 0;
    /*Read OVPD*/
...
static kal_uint32 return_sensor_id(void)
{
    return (((read_cmos_sensor(0x300a) << 16) | (read_cmos_sensor(0x300b) << 8) |
              read_cmos_sensor(0x300c)) + SENSOR_ID_OFFSET_BAIKALL5);
}
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                pr_err("[get_imgsensor_id] OV50D40 Read sensor id Success, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
            ...
            pr_err("[get_imgsensor_id] OV50D40 Read sensor id fail, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
            retry--;
        } while (retry > 0);
            i++;
        retry = 2;
...
UINT32 OV50D40_MIPI_RAW_BAIKALL5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
