...
#include "imx480mipiraw_baikall5_Sensor.h"
...
#define DEVICE_VERSION_IMX480    "imx480"
#define LEFT_SIZE (0x4000)
#define READ_EEPROM_1K (1024)
#define MODULE_ID_OFFSET 0x0000
#define IMX480_BAIKALL5_EEPROM_I2C_ADDR 0xA8
#define FOUR_CELL_QSC_START 0x1300
#define FOUR_CELL_QSC_SIZE 560
#endif

#define PFX "IMX480_camera_sensor"
...
static BYTE imx480_baikall5_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX480_SENSOR_ID_BAIKALL5,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
    {4656, 3496, 24, 20, 4608, 3456, 2304, 1728,  0,  0, 2304, 1728, 0, 0, 2304, 1728}, /* preview 4:3*/
    {4656, 3496, 24, 20, 4608, 3456, 2304, 1728,  0,  0, 2304, 1728, 0, 0, 2304, 1728}, /* capture 4:3*/
    {4656, 3496, 24, 444, 4608, 2608, 2304, 1304, 0,  4, 2304, 1296, 0, 0, 2304, 1296}, /* normal-video 16:9*/
    ...
    {4656, 3496, 24, 20, 4608, 3456, 4608, 3456,  0,  0, 4608, 3456, 0, 0, 4608, 3456}, /* custom3 remosaic 4:3*/
    {4656, 3496, 696, 504, 3264, 2488, 1632, 1244,  0,  0, 1632, 1244, 0, 0, 1632, 1244}, /* custom4 1632x1244*/
    {4656, 3496, 24, 596, 4608, 2304, 2304, 1152,  0,  0, 2304, 1152, 0, 0, 2304, 1152}, /* custom5 18:9 2304x1152*/
};
...
{
    char pusendcmd[2] = {(char)(addr >> 8), (char)(addr & 0xFF) };
    iReadRegI2C(pusendcmd, 2, (u8 *)table, size,IMX480_BAIKALL5_EEPROM_I2C_ADDR);
}
...
{
    LOG_INF("E! cap 2304x1728_30fps currefps:%d\n", currefps);
...
{
    LOG_INF("E! 2304x1296_30fps  currefps:%d\n", currefps);
...
{
    LOG_INF("zef_imx480 18:9 2304x1152 30fps size start\n");
    table_write_cmos_sensor(addr_data_pair_custom5,
        sizeof(addr_data_pair_custom5) / sizeof(kal_uint16));
    LOG_INF("zef_imx480 18:9 2304x1152 30fps size end\n");
}

static kal_uint16 read_imx480_baikall5_eeprom_module(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };

	iReadRegI2C(pusendcmd, 2, (u8 *) &get_byte, 1, IMX480_BAIKALL5_EEPROM_I2C_ADDR);

	return get_byte;
}

static void read_imx480_baikall5_module_data()
{
// imx480_baikall5_common_data
// length   : 64
// QR       : [8 ~ 26]
// vcm      : [40 ~ 41]
// lensid   : [44 ~ 45]
// sensorid : [30 ~ 33]
	...
	memset(imx480_baikall5_common_data, 0, sizeof(imx480_baikall5_common_data));
	// QR
	for(idx = 0; idx < sn_length; idx++)
	{
		imx480_baikall5_common_data[8 + idx] = read_imx480_baikall5_eeprom_module(sn_starAddr + idx);
	}
	//vcm
	imx480_baikall5_common_data[40] = read_imx480_baikall5_eeprom_module(vcmAddr);
	imx480_baikall5_common_data[41] = read_imx480_baikall5_eeprom_module(vcmAddr + 1);
	//lensid
	imx480_baikall5_common_data[44] = read_imx480_baikall5_eeprom_module(lensAddr);
	imx480_baikall5_common_data[45] = read_imx480_baikall5_eeprom_module(lensAddr + 1);

	for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4)
		pr_err("imx480eeprom_moduleinfo cam data, idx: %02x %02x %02x %02x %d\n",
		       imx480_baikall5_common_data[idx],
		       imx480_baikall5_common_data[idx + 1],
		       imx480_baikall5_common_data[idx + 2],
		       imx480_baikall5_common_data[idx + 3],
			   idx);
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
        ...
        *sensor_id = return_sensor_id();
        if (*sensor_id == 0x0471) {
            *sensor_id = imgsensor_info.sensor_id;
            pr_err("IMX480 get_imgsensor_id success: 0x%x\n", *sensor_id);
            if (otp_data[0] == 0) {
            ...
            read_imx480_baikall5_module_data();
            return ERROR_NONE;
        }
    ...
    if (*sensor_id != imgsensor_info.sensor_id) {
        pr_err("IMX480 get_imgsensor_id failed: 0x%x\n", *sensor_id);
...
static kal_uint32 open(void)
{
    ...
    if (imgsensor_info.sensor_id != sensor_id) {
        printk("IMX480 open failed: 0x%x\n", sensor_id);
        return ERROR_SENSOR_CONNECT_FAIL;
    }
    #else
    if (imgsensor_info.sensor_id !=  sensor_id)
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_EEPROM_COMDATA:
        memcpy(feature_return_para_32, imx480_baikall5_common_data, CAMERA_EEPPROM_COMDATA_LENGTH);
    ...
    case SENSOR_FEATURE_GET_BINNING_TYPE:
        switch (*(feature_data + 1)) {
            ...
            case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
            default:
               *feature_return_para_32 = 2; /*BINNING_SUM*/
               break;
        }
...
UINT32 IMX480_MIPI_RAW_BAIKALL5_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc !=  NULL)
        *pfFunc= &sensor_func;
    return ERROR_NONE;
}   /*  IMX480_MIPI_RAW_SensorInit  */
