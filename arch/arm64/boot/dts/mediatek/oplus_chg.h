...
#define OPLUS_CHG_IC_SWITCH		0x12
#define OPLUS_CHG_IC_VIRTUAL_SWITCH	0x13
#define OPLUS_CHG_IC_CP			0x14
#define OPLUS_CHG_IC_VIRTUAL_UFCS	0x15
#define OPLUS_CHG_IC_MISC		0x16
#define OPLUS_CHG_IC_PPS		0x17
#define OPLUS_CHG_IC_VIRTUAL_PPS	0x18
#define OPLUS_CHG_IC_UFCS		0x19
...
#define OPLUS_IC_FUNC_BUCK_SET_FLASH_MODE		(OPLUS_IC_FUNC_NUM_BUCK_START + 47)
...
#define OPLUS_IC_FUNC_GAUGE_GET_GAUGE_TYPE		(OPLUS_IC_FUNC_NUM_GAUGE_START + 89)
...
/* pps */
#define OPLUS_IC_FUNC_NUM_PPS_START			1000
#define OPLUS_IC_FUNC_PPS_HANDSHAKE			    (OPLUS_IC_FUNC_NUM_PPS_START + 0)
#define OPLUS_IC_FUNC_PPS_PDO_SET			    (OPLUS_IC_FUNC_NUM_PPS_START + 1)
#define OPLUS_IC_FUNC_PPS_HARD_RESET		    (OPLUS_IC_FUNC_NUM_PPS_START + 2)
#define OPLUS_IC_FUNC_PPS_EXIT			        (OPLUS_IC_FUNC_NUM_PPS_START + 3)
#define OPLUS_IC_FUNC_PPS_CONFIG_WD			    (OPLUS_IC_FUNC_NUM_PPS_START + 4)
#define OPLUS_IC_FUNC_PPS_GET_DEV_INFO			(OPLUS_IC_FUNC_NUM_PPS_START + 5)
#define OPLUS_IC_FUNC_PPS_GET_ERR_INFO			(OPLUS_IC_FUNC_NUM_PPS_START + 6)
#define OPLUS_IC_FUNC_GET_PPS_STATUS			(OPLUS_IC_FUNC_NUM_PPS_START + 7)
#define OPLUS_IC_FUNC_PPS_GET_CABLE_INFO		(OPLUS_IC_FUNC_NUM_PPS_START + 8)
#define OPLUS_IC_FUNC_PPS_GET_PDO_INFO			(OPLUS_IC_FUNC_NUM_PPS_START + 9)
#define OPLUS_IC_FUNC_PPS_VERIFY_ADAPTER		(OPLUS_IC_FUNC_NUM_PPS_START + 10)
#define OPLUS_IC_FUNC_PPS_GET_POWER_CHANGE_INFO		(OPLUS_IC_FUNC_NUM_PPS_START + 11)
#define OPLUS_IC_FUNC_FIXED_PDO_SET			    (OPLUS_IC_FUNC_NUM_PPS_START + 12)
